...
export function Services() {
  return (
    <section
      id="services"
      className="bg-lawn-bg-1 flex min-h-screen scroll-mt-5 flex-col items-center justify-center gap-12 px-4 py-16 sm:px-6 sm:py-24 lg:flex-row lg:gap-10 lg:px-10 lg:py-24 xl:gap-16 xl:px-16 2xl:gap-[172px] 2xl:px-[240px] 2xl:py-32"
    >
