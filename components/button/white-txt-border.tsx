...
const whiteTxtBorderButtonVariants = cva(
...
function WhiteTxtBorderButton({
  className,
  variant = "default",
  size = "default",
  ...props
}: ButtonPrimitive.Props & VariantProps<typeof whiteTxtBorderButtonVariants>) {
  return (
    <ButtonPrimitive
      data-slot="button-outline-white"
      className={cn(whiteTxtBorderButtonVariants({ variant, size, className }))}
      {...props}
    />
  );
}

export { WhiteTxtBorderButton, whiteTxtBorderButtonVariants };
