...
function GreenButton({
  ...
  size = "default",
  ...props
}: ButtonPrimitive.Props & VariantProps<typeof greenButtonVariants>) {
  return (
    <ButtonPrimitive
      data-slot="button-solid-emerald"
      className={cn(greenButtonVariants({ variant, size, className }))}
      {...props}
    />
  );
}

export { GreenButton, greenButtonVariants };
